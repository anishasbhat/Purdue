...
public class Part4SimTest {
	...
	String patientFile = "/Users/anishasbhat/Downloads/CS251/Proj2/src/patient_file_1.txt";
	getPatients(patientFile);
	numPatients = patients.size();
	//args = new String[]{"patient_file_1.txt", "25", "5", "50", "50", "50", "50"};
	
	//set up Clinic and Random generator
	clinic = new Clinic(Integer.parseInt("15"), Integer.parseInt("15"));
	gen = new Random(System.currentTimeMillis());

	//set probability variables
	pWalkIn = Integer.parseInt("50");
	pDocAvailable = Integer.parseInt("50");
	pEmergency = Integer.parseInt("50");
	pWalkOut = Integer.parseInt("50");
