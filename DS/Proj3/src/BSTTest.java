...
public class BSTTest 
{
    ...
    private static boolean test(int testNum) 
    {
		...
		String iFile = "/Users/anishasbhat/Downloads/CS251/Proj3/src/testFiles/test_" + testNum + "_input.txt";
		String eFile = "/Users/anishasbhat/Downloads/CS251/Proj3/src/testFiles/test_" + testNum + "_expected.txt";
		String actual = "";
		String expected = "";
